...
export class OnFieldService {
    ...
    onFieldSimConversionList(requestBody: any): Observable<ICommonResponse> {
        return this.http.post<ICommonResponse>(this.url + '/OnFieldSimConversionList', requestBody);
    }
